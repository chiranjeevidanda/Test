...
import { OUTBOUND_TRANSACTION_ORDER_TYPE } from '../../../constents/constants';
import { fetchExports, fetchItems, resetFilterFormData, selectFilterFormData, updateFilterFormData } from '../../../features/outbound/OutboundTransactionsSlice';


const OutboundTransactionsSearchBar = ({ showMessage, setShowMessage }) => {
    ...
    const handleChange = (e) => {
        ...
        const updatedFilterFormData = { ...filterFormData, [name]: value, skip: 0 };
        dispatch(updateFilterFormData(updatedFilterFormData));
        dispatch(fetchItems(updatedFilterFormData));
    };
    ...
    const handleSearch = (event) => {
        ...
        if (elementName === 'btnhandleSearch' && (filterFormData.documentType == null || filterFormData.documentType === '')) {
            ...
            <div className="bg-white p-4 rounded-lg shadow-md mb-6 mx-5 flex items-center space-x-4">
                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        {Object.values(OUTBOUND_TRANSACTION_ORDER_TYPE).map(type => (
                ...
                <div className="flex-1-">
                    <label className="block text-gray-700 mb-1 font-thin">Order Number/SKU</label>
                    <input
                        type="text"
                        name="orderNumber"
                        ...
                        className="w-full p-2 border border-gray-300 rounded"
                    />
                    {/*<small class="form-text text-muted">Multiple IDs should be seperated by comma or space</small> */}
                </div>
...
export default OutboundTransactionsSearchBar;
