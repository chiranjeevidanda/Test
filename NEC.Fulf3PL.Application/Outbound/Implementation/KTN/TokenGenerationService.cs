...
{
    public class TokenGenerationService : ITokenGenerationService<GenerateTokenDTO>
    {
        private readonly ILogger<TokenGenerationService> logger;
        private readonly IConfiguration configuration;
        private readonly IRequestHandler requestHandler;
        private readonly IOutboundTransactionRepository outboundTransactionRepository;
        public TokenGenerationService(ILogger<TokenGenerationService> logger, IConfiguration configuration, IRequestHandler requestHandler, IOutboundTransactionRepository outboundTransactionRepository)
        {
            this.logger = logger;
