...
{
    public class ItemMasterService : IItemMasterService<OutboundConverterModel>
    {
        private readonly ILogger<ItemMasterService> logger;
        ...
        public ItemMasterService(ILogger<ItemMasterService> logger, IConfiguration configuration, IRequestHandler requestHandler, IOutboundTransactionRepository outboundTransactionRepository, IItemMasterRequestRepository itemMasterRequestRepository)
        {
            this.logger = logger;
        ...
        public async Task<ExecuteResult<bool>> PostData(OutboundConverterModel convertedData)
        {
            ...
            if (endpointType.Equals(Enums.OutboundAPIEndpoint.ProductMaster))
            {
                ...
                externalRequest = await CreateAPIRequest(endpointURL: configuration["KtnProductMasterAPI"],
            ...
            if (providerResponse.Success && providerResponse.Result != null)
            {
                ...
                if (productData != null)
                {
                    await UpdateItemDetails(productData.Code, productData.Reference1);
                }
        ...
        public async Task<ExecuteResult<bool>> PutData(OutboundConverterModel convertedData, string systemId)
        {
            ...
            if (endpointType.Equals(Enums.OutboundAPIEndpoint.ProductMaster))
            {
                ...
                externalRequest = await CreateAPIRequest(endpointURL: string.Format(configuration["KtnUpdateProductAPI"], systemId),
                ...
                if (blobResponse != null)
                {
                    ...
                    if (Enum.TryParse<Enums.OutboundAPIEndpoint>(blobResponse.InboundEndpoint, true, out endpointType))
                    {
                        ...
                        if (endpointType.Equals(Enums.OutboundAPIEndpoint.ProductMaster))
                        {
                            ...
                            externalRequest.URL = configuration["KtnProductMasterConverter"];
