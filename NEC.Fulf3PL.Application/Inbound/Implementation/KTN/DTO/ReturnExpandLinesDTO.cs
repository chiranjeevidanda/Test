...
{
    public class ReturnExpandLinesDTO
    {
        ...
        public List<ReturnAddressDTO> Addresses { get; set; }

        [JsonProperty("returnLines")]
        public List<ReturnLineItemDetails> Lines { get; set; }
    ...
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public class ReturnLineItemDetails
    {
