...
{
    public class TransportOutboundWebSubscription : WebhookSubscription, IWebhookSubscription
    {
        private readonly ILogger<WebhookSubscription> logger;

        public TransportOutboundWebSubscription(ILogger<WebhookSubscription> logger, IConfiguration configuration, ITokenGenerationService<GenerateTokenDTO> iTokenGenerationService, IRequestHandler requestHandler)
        ...
        public override async Task<ExecuteResult<WebhookSubsciptionsPatchResponse>> ExtendSubscription(WebhookSubscriptionData subscription, Enums.WebhookSubscriptionType key, string customer = Constants.NEWERAB2B)
        {
            ...
            logger.LogInformation($"Successfully extended {nameof(TransportOutboundWebSubscription)}");
            return result;
        }
        //#region Dispose
        ...
        //~TransportOutboundWebSubscription()
        //{
        //    Dispose(false);
        //}
        //#endregion Dispose
