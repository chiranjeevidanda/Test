...
{
    public class SofiaReturnReceived : IReturnReceived<InboundConverterModel>
    {
        private readonly ILogger<SofiaReturnReceived> logger;
        private readonly IRequestHandler requestHandler;
        private readonly ISofiaInboundRequestsRepository sofiaInboundRequestsRepository;

        public SofiaReturnReceived(ILogger<SofiaReturnReceived> logger, IRequestHandler requestHandler, ISofiaInboundRequestsRepository sofiaInboundRequestsRepository)
        {
            this.logger = logger;
