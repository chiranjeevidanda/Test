...
namespace NEC.Fulf3PL.Application.Inbound.Implementation.GEODIS.SOFIA
{
    public class GeodisInboundSofiaService : IGeodisInboundService<InboundConverterModel>
    {
        private readonly ILogger<GeodisInboundSofiaService> logger;
        private readonly IRequestHandler requestHandler;
        private readonly ISofiaInboundRequestsRepository sofiaInboundRequestsRepository;

        public GeodisInboundSofiaService(ILogger<GeodisInboundSofiaService> logger, IRequestHandler requestHandler, ISofiaInboundRequestsRepository sofiaInboundRequestsRepository)
        {
            this.logger = logger;
        ...
        public Task<ExecuteResult<InboundConverterModel>> GetData(InboundConverterModel convertedData, string requestURL)
        {
            throw new NotImplementedException();
        }

        public Task<ExecuteResult<InboundConverterModel>> MapData(string request, string requestURL)
        {
            throw new NotImplementedException();
        }
